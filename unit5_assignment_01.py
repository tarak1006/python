...
def test_de_dup_and_sort_student():
    assert ["subbu","tarak"] == de_dup_and_sort(["tarak","subbu","tarak"])
    assert ["s","suba","subbu","tarak"]==de_dup_and_sort(["tarak","subbu","suba","s"])
    assert ["TARAK","tarak"]==de_dup_and_sort(["tarak","TARAK"])
